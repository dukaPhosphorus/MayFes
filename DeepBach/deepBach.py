...
def main():
    ...
    if args.midi_file:
        ...
        #melody.show()
        #print(melody)
        #print(len(args.midi_file))
        #print(len(args.midi_file[0]))
        #print(len(args.midi_file[1]))
        #print(melody.parts[0],len(melody[0]),len(melody[1]),len(melody[2]),len(melody[3]))
        #print(melody.parts[0].duration.quarterLength*SUBDIVISION)
        melody = part_to_inputs(melody.parts[0],int(melody.parts[0].duration.quarterLength*SUBDIVISION),index2note=index2notes[0], note2index=note2indexes[0])
