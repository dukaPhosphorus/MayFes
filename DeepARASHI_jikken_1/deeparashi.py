...
from data_utils import initialization, START_SYMBOL, END_SYMBOL, all_metadatas, standard_note, SOP, BASS, ARASHI_DATASET, generator_from_raw_dataset, all_features, indexed_chorale_to_score, melody_to_inputs, make_local_sequences#, pickled_dataset_path, \,
...
def generation(model_base_name, models, timesteps, melody=None, chorale_metas=None,
               ...
               sequence_length=160,
               output_file=None, pickled_dataset=ARASHI_DATASET):
...
def create_models(model_name=None, create_new=False, num_dense=200, num_units_lstm=[200, 200],
                  pickled_dataset=ARASHI_DATASET, num_voices=4, metadatas=None, timesteps=16):
    """
    Choose one model
    :param model_name:
    :return:
...
def train_models(model_name, steps_per_epoch, num_epochs, validation_steps, timesteps, pickled_dataset=ARASHI_DATASET,
