...
def deepBach_chord(num_features_lr, num_features_c, num_pitches, num_features_meta, num_localseqs_lr, num_units_lstm=[200],
    ...
    ######################### input local datas ##########################
    left_local_seqs = Input(shape=(2, num_localseqs_lr), name='left_local_seqs')       ##5=local_seq_length 
    right_local_seqs = Input(shape=(2, num_localseqs_lr), name='right_local_seqs')     ##5=local_seq_length 
    ######################################################################
    ...
    predictions_local_left = LSTM(100,
                                return_sequences=False,
                                  name='lstm_local_left_0')(predictions_local_left)
    predictions_local_right = LSTM(100,
                                return_sequences=False,
